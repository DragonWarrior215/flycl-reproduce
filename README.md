...
框架架构、数据管线、配置规范的完整剖析见 [`docs/libcontinual_arch.md`](docs/libcontinual_arch.md)；
算法与论文的逐条映射见 [`docs/paper_analysis.md`](docs/paper_analysis.md)。
...
docs/                                 框架剖析、论文精读、完整实验报告
results/                              全部结果 json/csv/png；official_framework/ 为官方框架日志
```

详细文档：[`docs/experiment_report.md`](docs/experiment_report.md)（完整实验报告）、
[`docs/paper_analysis.md`](docs/paper_analysis.md)（论文精读与映射）、
[`docs/libcontinual_arch.md`](docs/libcontinual_arch.md)（框架剖析）。
